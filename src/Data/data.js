...
export const allSportsArticle = articles.filter(
  article => article.category === 'sport'
);
export const allCrimesArticle = articles.filter(
  article => article.category === 'crime'
);
export const allInternationallsArticle = articles.filter(
  article => article.category === 'world'
);
export const allentertainmentsArticle = articles.filter(
  article => article.category === 'entertainment'
);
export const allSwedisgArticle = articles.filter(
  article => article.category === 'sweden'
);
...
const swedenArticles = articles.filter(
  article => article.category === 'sweden'
);
...
const sportsArray = [
  removeArticle(sportArticles),
  removeArticle(sportArticles),
];

export const recentArticles = [
  removeArticle(swedenArticles),
  removeArticle(internationalArticles),
  removeArticle(crimeArticles),
  removeArticle(entertainmentArticles),
];

const swedishCategory = [];
const sportsCategory = [];
const crimesCategory = [];
const worldsCategory = [];
const entertainmentsCategory = [];

for (let i = 0; i < 3; i++) {
  swedishCategory.push(removeArticle(swedenArticles));
  sportsCategory.push(removeArticle(sportArticles));
  crimesCategory.push(removeArticle(crimeArticles));
  worldsCategory.push(removeArticle(internationalArticles));
  entertainmentsCategory.push(removeArticle(entertainmentArticles));
}
...
export const breakingNews = articles.filter(
  article => !usedArticles.includes(article)
);
